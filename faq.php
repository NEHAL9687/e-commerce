		...
		<div class="container">
			...
			<div class="faq-w3agile">
				<ul class="faq">
                                    ...
                                    $faqq = mysqli_query($connection, "select * from  tbl_faq") or die(mysqli_error($connection));
                                    
                                    $i = 1;
                                    while($faqrow = mysqli_fetch_array($faqq))
                                    {
                                        $i++;
                                        echo "<li class='item$i'>
						<a href='#' title='click here'>{$faqrow['faq_question']}</a>
						<ul>
							<li class='subitem$i'>
