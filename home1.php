...
<body>
	...
	<div class="contact-w3l">
		<div class="container">
			<!-- tittle heading -->
			<h3 class="tittle-w3l"> Welcome User
			...
			<div class="contact agileits">
				<div class="contact-agileinfo">
					<div class="contact-form wthree">
                                            ...
                                            echo "<th>shipping_name</th>";
                                            
                                            echo "<th>shipping_mobile</th>";
                                            echo "<th>shipping_address</th>";
                                            echo "</tr>";
                                             $q = mysqli_query($connection, "select * from tbl_ordermaster where user_id ='{$_SESSION['uid']}'") or die(mysqli_error($connection));
