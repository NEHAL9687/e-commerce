	...
	<div class="banner-bootom-w3-agileits">
		<div class="container">
			...
			<div class="col-md-5 single-right-left ">
				<div class="grid images_3_of_2">
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="admin/<?php echo $productrow['product_image'] ?>">
								<div class="thumb-image">
                                                                    <img src="admin/<?php echo $productrow['product_image'] ?>" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
			...
			<div class="col-md-7 single-right-left simpleCart_shelfItem">
				...
				<p>
					<span class="item_price">Rs.<?php echo $productrow['product_price']; ?></span>
					<del>Rs.<?php echo $productrow['product_price'] + 1000; ?></del>
				...
				<div class="product-single-w3l">
					<p>
						<?php echo $productrow['product_details']; ?> 
					<p>
