                                                    ...
                                                    if(isset($_SESSION['productcart']) && !empty($_SESSION['productcart']))
{
    ...
    echo "<tr>";
    echo "<td class='invert'>$no</td>";
    echo "<td class='invert'>{$productdata['product_name']}</td>";
    echo "<td class='invert'>{$productdata['product_price']}</td>";
    echo "<td class='invert'>{$_SESSION['qtycart'][$key]}</td>";
    echo "<td class='invert'>$subtotal</td>";
    echo "<td class='invert'><img src='admin/{$productdata['product_image']}' width='100px;'></td>";
    echo "<td class='invert'><a href='?remove=$key'>Remove</a></td>";
    echo "</tr>";
    ...
    $sum[] = $subtotal;
     ...
     echo "Buy New Products <a href='product-listing.php'>Buy</a>";
}else
{
    echo "Buy New Products <a href='product-listing.php'>Buy</a>";
}
			...
			<div class="checkout-left">
				<div class="address_form_agile">
					<h4>Add Shipping Details</h4>
                                        <form action="place-order.php" method="post" class="creditly-card-form agileinfo_form">
												...
												<input type="text" placeholder="Address" name="address" required="">
                                                                            ...
                                                                            <div class="w3_agileits_card_number_grid_right">
                                                                                <div class="controls" style=" width:100px;">
                                                                                            Payment Mode : <input type="radio" name="" checked=""> Cash on Delivery
											</div>
										</div>
										<div class="clear"> </div>
									</div>
					...
					<div class="checkout-right-basket">
                                            ...
                                            <input type="submit" class="fa fa-hand-o-right button" value="Confirm Order">
					</div>
                                            </form>
				</div>
