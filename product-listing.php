	...
	<div class="services-breadcrumb">
		<div class="agile_inner_breadcrumb">
			<div class="container">
				<ul class="w3_short">
					<li>
                                            <a href="product-listing.php">Home</a>
						<i>|</i>
					</li>
		...
		<div class="container">
			...
			<div class="agileinfo-ads-display col-md-9 w3l-rightpro">
					...
					<div class='product-sec1'>
                            ...
                            {
                                $cid = $_GET['cid'];
                                 $productq = mysqli_query($connection, "select * from tbl_product where category_id ='{$cid}'") or die(mysqli_error($connection));
                          
                            }else if(isset($_GET['search']))
                            {
                                   $search = $_GET['search'];
                                 $productq = mysqli_query($connection, "select * from tbl_product where  product_name like '%$search%'") or die(mysqli_error($connection));
                          
                            }
                             else   
                            
                            {
                                 $productq = mysqli_query($connection, "select * from tbl_product") or die(mysqli_error($connection));
						...
						<div class='col-xs-4 product-men'>
							<div class='men-pro-item simpleCart_shelfItem'>
								<div class='men-thumb-item' 'style:width:100px;height:100px;'> 
									<img src='admin/{$productrow['product_image']}' style='width:200px;height:200px;'>
                                                                          
<div class='men-cart-pro'>
										<div class='inner-men-cart-pro'>
											<a href='product-details.php?pid={$productrow['product_id']}' class='link-product-add-cart'>Quick View</a>
										</div>
									</div>
								...
								<div class='item-info-product '>
									<h4>
										<a href='product-details.php?pid={$productrow['product_id']}'>{$productrow['product_name']}</a>
									</h4>
									<div class='info-product-price'>
										<span class='item_price'>Rs. {$productrow['product_price']}</span>
										...
										<form action='cart-process.php' method='get'>
											<fieldset>
												...
												<input type='hidden' name='qty' value='1' />
                                                                                                <input type='hidden' name='pid' value='{$productrow['product_id']}' />
