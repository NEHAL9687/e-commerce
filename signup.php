...
if ($_POST) {
    ...
    $q = mysqli_query($connection, " insert into tbl_usermaster (user_name,user_gender,user_email,user_password,user_mobile,user_address,area_id)"
            . " values('{$name}','{$gender}','{$email}','{$password}','{$mobile}','{$address}','1') ") or die(mysqli_error($connection));
