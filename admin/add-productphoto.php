...
if ($_POST) {
   ...
   // $product_image = mysqli_real_escape_string($connection, $_POST['product_image']);
    ...
    $q = mysqli_query($connection, "insert into tbl_productphoto(product_id,productphoto_path) values('{$product_id}','{$productphoto_path}')") or die(mysqli_error($connection));
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="outer-w3-agile col-xl mt-3 mr-xl-3">
                                <h4 class="tittle-w3-agileits mb-4"> Product Photo Information </h4>
                                <form   method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="file" class="form-control" id="inputPassword3" name="productphoto_path" placeholder="Enter Product Photo Path" required="">
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <div class="col-sm-10">
                                            <button type="submit" name="submit" class="btn btn-primary"> Add Product Photo Path </button>
