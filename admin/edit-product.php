...
$q = mysqli_query($connection, "select * from tbl_product where product_id='{$editid}'") or die(mysqli_error($connection));
...
if ($_POST) 
{
    ...
    $qupdate = mysqli_query($connection, "update tbl_product set product_name='{$product_name}',product_details='{$product_details}',product_price='{$product_price}',product_image='{$product_image}',category_id='($category_id)' where product_id='{$product_id}'") or die(mysqli_error($connection));
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="outer-w3-agile col-xl mt-3 mr-xl-3">
                                <h4 class="tittle-w3-agileits mb-4"> Edit Product Information </h4>
                                <form   method="post" enctype="multipart/form-data">
                                    <input type="hidden" class="form-control" id="inputEmail3" value="<?php echo $qrow['product_id'] ?>" name="product_id">
                                    
                                    <form   method="post" enctype="multipart/form-data">
                                    <div class="form-group row">
                                        <label for="inputPassword3" class="col-sm-2 col-form-label"> Product Name </label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="inputPassword3" name="product_name" value="<?php echo $qrow['product_name'] ?>" placeholder="Enter Product Name" required="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="inputEmail3" class="col-sm-2 col-form-label"> Product Details </label>
                                        <div class="col-sm-10">
                                            <textarea class="form-control" name="product_details" placeholder="Enter Product Details" required=""> <?php echo $qrow['product_details'] ?> </textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="inputPassword3" class="col-sm-2 col-form-label"> Product Price </label>
                                        <div class="col-sm-10">
                                            <input type="number" class="form-control" id="inputPassword3" name="product_price" value="<?php echo $qrow['product_price'] ?>" placeholder="Enter Product Price" required="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="inputPassword3" class="col-sm-2 col-form-label"> Product Image </label>
                                        <div class="col-sm-10">
                                            <input type="file" class="form-control" id="inputPassword3" name="product_image" value="<?php echo $qrow['product_image'] ?>" placeholder="Enter Product Image" required="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
