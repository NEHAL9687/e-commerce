...
if ($_POST) {
    ...
    $q = mysqli_query($connection, "insert into tbl_usermaster(user_name,user_gender,user_email,user_password,user_mobile,user_address,area_id) values('{$user_name}','{$user_gender}','{$user_email}','{$user_password}','{$user_mobile}','{$user_address}','{$area_id}')") or die(mysqli_error($connection));
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="outer-w3-agile col-xl mt-3 mr-xl-3">
                                <h4 class="tittle-w3-agileits mb-4"> User Master Information </h4>
                                <form   method="post" enctype="multipart/form-data">

                                    <div class="form-group row">
                                        <label for="inputPassword3" class="col-sm-2 col-form-label"> Name </label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="inputPassword3" name="user_name" placeholder="Enter User Name" required="">
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="email" class="form-control" name="user_email" id="inputEmail3" placeholder="Enter Email Id" required="">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="inputPassword3" class="col-sm-2 col-form-label"> Password </label>
                                            <div class="col-sm-10">
                                                <input type="password" class="form-control" name="user_password" id="inputPassword3" placeholder="Enter Password" required="">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="inputPassword3" class="col-sm-2 col-form-label">  Mobile No </label>
                                            <div class="col-sm-10">
                                                <input type="number" class="form-control" id="inputPassword3" name="user_mobile" placeholder="Enter User Mobile No" required="">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="inputEmail3" class="col-sm-2 col-form-label">  Address </label>
                                            <div class="col-sm-10">
                                                <textarea class="form-control" name="user_address"  placeholder="Enter User Address" required=""></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
