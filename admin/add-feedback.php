...
if ($_POST) {
    ...
    $orderdetails_id = mysqli_real_escape_string($connection, $_POST['order_details']);

    $q = mysqli_query($connection, "insert into tbl_feedback(feedback_date,user_id,order_details) values('{$feedback_date}','{$user_id}','{$orderdetails_id}') ") or die(mysqli_error($connection));
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="outer-w3-agile col-xl mt-3 mr-xl-3">
                                <h4 class="tittle-w3-agileits mb-4"> Feedback Information </h4>
                                <form   method="post" enctype="multipart/form-data">
                                    <div class="form-group row">
                                        <label for="inputEmail3" class="col-sm-2 col-form-label"> Feedback-Date </label>
                                        <div class="col-sm-10">
                                            <input type="date" class="form-control" id="inputEmail3" name="feedback_date" placeholder="Enter Feedback-Date" required="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <?php 
                                                ...
                                                echo "<select name='order_details' class='form-control'>";
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-10">
                                            <button type="submit" class="btn btn-primary"> Add Feedback-Date</button>
