...
$q = mysqli_query($connection, "select * from tbl_orderdetails where orderdetails_id='{$editid}'") or die(mysqli_error($connection));
...
if ($_POST) 
{
  ...
  //  $admin_password = mysqli_real_escape_string($connection, $_POST['admin_password']);
    ...
    $qupdate = mysqli_query($connection, "update tbl_orderdetails set order_details='{$order_details}',order_id='{$order_id}',product_id='{$product_id}',order_quantity='{$order_quantity}',order_price='{$order_price}' where orderdetails_id='{$orderdetails_id}'") or die(mysqli_error($connection));
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="outer-w3-agile col-xl mt-3 mr-xl-3">
                                <h4 class="tittle-w3-agileits mb-4"> Edit Order Details </h4>
                                <form   method="post" enctype="multipart/form-data">
                                    
                                    <div class="form-group row">
                                        
                                        
                                            <input type="hidden" class="form-control" name="orderdetails_id" value="<?php echo $qrow['orderdetails_id'] ?>"  placeholder="Enter Order Details Id" required="">
                                        
                                    </div>
                                    <div class="form-group row">
                                        <label for="inputEmail3" class="col-sm-2 col-form-label"> Order Details </label>
                                        <div class="col-sm-10">
                                            <textarea class="form-control" name="order_details"  placeholder="Enter Order Details" required=""> <?php echo $qrow['order_details'] ?> </textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number" class="form-control" id="inputEmail3" name="order_quantity" value="<?php echo $qrow['order_quantity'] ?>" placeholder="Enter Order Quantity" required="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="inputEmail3" class="col-sm-2 col-form-label"> Order Price </label>
                                        <div class="col-sm-10">
                                            <input type="number" class="form-control" id="inputEmail3" name="order_price" value="<?php echo $qrow['order_price'] ?>" placeholder="Enter order_price" required="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-10">
